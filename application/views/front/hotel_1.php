                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#"
                                                    class="breadcrumb-link">Hotel</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"> Maharaja Hotel And Restaurants
                                                </li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        if(!empty($data)){ foreach($data as $master){ 
                            ...
                            <div class="col-xl-4 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card info-card">
                                    ...
                                    <div class="top-left"> 
                                    <img src="<?php echo base_url().'assets/images/Daas_Logo_main.jpg';?>"
                                    class="img-fluid">
                                    </div>
